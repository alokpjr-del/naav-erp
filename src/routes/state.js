...
router.get('/', async (req, res) => {
    try {
        ...
        const restaurants = restaurantsResult.rows.map((restaurant) => ({
            ...
            contactPerson: restaurant.contactPerson !== undefined ? restaurant.contactPerson : restaurant.contact_person,
            mobile: restaurant.mobile,
            altMobile: restaurant.altMobile !== undefined ? restaurant.altMobile : restaurant.alt_mobile,
            address: restaurant.address,
            gst: restaurant.gst,
            email: restaurant.email,
            openTime: restaurant.openTime !== undefined ? restaurant.openTime : restaurant.open_time,
            closeTime: restaurant.closeTime !== undefined ? restaurant.closeTime : restaurant.close_time,
